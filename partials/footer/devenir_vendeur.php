...
<meta name="description"
      content="Vous travaillez pour une marque de mode éthique et souhaitez élargir vos canaux de distribution ? Remplissez ce formulaire pour devenir vendeur sur notre marketplace de mode éthique !">
...
<div class="contenu">
    <div class="form-etiquette">
        ...
        <p>Nous somes en train de développer une marketplace de mode éthique. Vous souhaitez nous proposer des produits
            ? Merci de bien vouloir remplir le formulaire ci-dessous, nous vous
        ...
        <form action="sql/devenir_vendeur.php" method="post">
            <h2>Entreprise</h2>
            <label for="nom_entreprise"><span>Nom de l'entreprise</span>
                <input
                        type="text"
                        class="input-field"
                        name="nom_entreprise"
            ...
            <!--                                                                                             required/>-->
            <!--            </label>-->
            <label for="site_internet"><span>Site internet</span>
                <input type="text"
                                                                        class="input-field"
                                                                        name="site_internet"
                />
